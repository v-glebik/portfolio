...
class AddSalonContainer extends PureComponent {
  constructor(props) {
    super(props);
  ...
  getInitialState = () => {
    ...
    const initialState = Object.assign({}, values);
    Object.keys(initialState).forEach((val) => {
      if (val === 'photos' || val === 'opening_hours') {
        initialState[val] = [];
      } else {
        initialState[val] = '';
      }
